...
DataFile = "data/asorici_left_wrist_test.bin" 
ImportedData = dataImport(DataFile, downsample = 100, Use.Timestamps = TRUE, start = 1641494890, end = 1641577702)
head(ImportedData)
```
...
SegDataFile = segmentation(ImportedData, datacols = dataCols, samplefreq = 10, verbose = TRUE, verbose_timer = TRUE, outputfile = NULL, hysteresis = 0.05)
...
```{r segment a datafile, eval = FALSE}
 # Name of the file to analyse
DataFile = "DataDirectory/jl_left wrist_010094_2012-01-30 20-39-54.bin" 
SegDataFile = getGENEAsegments(DataFile, downsample=5, dataCols, start = 0, end = 0.1)
```
